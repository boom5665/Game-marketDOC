...
<div class="wrapper container">
            ...
            <div style="background: #f2f3f4; padding: 30px; margin-top: 1%; border-radius: .375rem;">
                ...
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="form-group col-12">
                        ...
                        <div class="pb-5"></div>
                        <label id="tabZero" set-lan="html:3. Define">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.กำหนดข้อมูล API ต่อไปนี้</label>
                        <div class="col-12">
    ...
    <span class="hljs-attr">"data"</span>: { 
        <span class="hljs-attr">"has_user"</span>: <span class="hljs-string">"yes"</span>,
    },
...
};
{
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>,
    <span class="hljs-attr">"data"</span>: { 
        <span class="hljs-attr">"has_user"</span>: <span class="hljs-string">"no"</span>,
    },
    <span class="hljs-attr">"mgs"</span>: <span class="hljs-string">"no game account"</span>
                ...
                <div class="col-12" id="tabSix" style="margin-left: 10px;">
                    <lable><b style="color: #0C3175 !important;" set-lan="text:3.5.1 GetUserBalance">3.5.1
                            GetUserDetail</b>
                    </lable>
                </div>
                <div class="btn-toolbar mb-3" role="toolbar">
        ...
        <span class="hljs-attr">"rate"</span>: {   
            ...
            <span class="hljs-attr">"yeekeelotto"</span>: {
                ...
                <div class="col-12" id="tabSixs" style="margin-left: 10px;">
                    <lable><b style="color: #0C3175 !important;" set-lan="text:3.5.1 GetUserBalance">3.5.2
    ...
    <span class="hljs-attr">"balance"</span>: <span class="hljs-number">50000</span>
                ...
                <div class="col-12" id="tabSeven">
                    <lable><b style="color: #0C3175 !important;" set-lan="text:3.5.2 UserPlaceBet">3.5.3
    ...
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>
                ...
                <div class="col-12" id="tabEight">
                    <lable><b style="color: #0C3175 !important;">3.5.4 UserPlaceBetCancel</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="form-group col-12">
    ...
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>
                ...
                <div class="col-12" id="tabNine">
                    <lable><b style="color: #0C3175 !important;">3.5.5 UserPlacePayout</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="form-group col-12">
                        <label set-lan="html:This interface will">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ถ้ามีการออกผลรางวัล ระบบ Game-market จะส่งคำขอ UserPlacePayout เมื่อมีการออกผลรางวัล</label>
                    </div>
                    <div class="form-group col-12 ex">
                        <lable><b style="color: #0C3175 !important;" set-lan="text:Request Body">Request Body</b>
                        </lable>
    ...
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>
                ...
                <div class="col-12" id="tab15">
                    <lable><b style="color: #0C3175 !important;">3.5.6 UserPlaceReToRunning</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <!-- <div class="form-group col-12">
    ...
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>
                ...
                <div class="col-12" id="tab16">
                    <lable><b style="color: #0C3175 !important;">3.5.7 UserPayReward</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <!-- <div class="form-group col-12">
    ...
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>
                ...
                <div class="col-12" id="tabTen">
                    <lable><b style="color: #0C3175 !important;">3.5.8 UserPayRewardCancel</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="form-group col-12 ex">
    ...
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>
                ...
                <lable id="tabEleven"><b style="color: #0C3175 !important;">3.6 Optional API</b></lable>
                <div class="pb-4"></div>
                <div class="col-12" id="tabFourteen">
                    <lable><b style="color: #0C3175 !important;">3.6.1 memberBetHistories</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="divBox">
    ...
    <span class="hljs-attr">"mgs"</span>: <span class="hljs-string">"Success"</span>
                ...
                <div class="col-12" id="tabTwelve">
                    <lable><b style="color: #0C3175 !important;">3.6.2 betHistories</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="divBox">
    ...
    <span class="hljs-attr">"mgs"</span>: <span class="hljs-string">"Success"</span>
                ...
                <div class="col-12" id="tabThirteen">
                    <lable><b style="color: #0C3175 !important;">3.6.3 GetListBetResult</b></lable>
                </div>
                <div class="pb-3"></div>
                <div class="btn-toolbar mb-3" role="toolbar">
                    <div class="divBox">
