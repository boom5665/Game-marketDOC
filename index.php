                    ...
                    <div class="btn-toolbar mb-3" role="toolbar">
                        <div class="form-group col-12">
                            <label
                                ...
                                API Service สร้างขึ้นเพื่อให้ผู้ใช้งานเข้าถึงเงื่อนไขสำหรับการทำงาน เช่น ฟังก์ชันการจัดการสมาชิก ฟังก์ชันการจัดการรายงาน ฟังก์ชันการจัดการสต๊อกและฟังก์ชันการถอนเงิน เอกสารนี้มีรายละเอียดสำหรับการเข้าถึงบริการการขยาย API ของระบบ</label>
                        </div>
                    </div>
